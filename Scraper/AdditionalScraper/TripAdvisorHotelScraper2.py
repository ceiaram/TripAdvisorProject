...
def get_page_contents(reviewPageUrl):
    print("Getting page contents of " + str(reviewPageUrl))
...
def get_green_leaders(soup):
    ...
    # If green tags are not found, than append none
    else:
        green_leader_scores.append('none')
        print("NO GREEN LEADER SCORE")
...
print(len(indices))
print(len(green_leader_scores))

# Create the dictionary.
dict = {'Index' : indices, 'Green Leaders Score' : green_leader_scores}
